<x-guestLayout> 
    <div class="flex flex-col min-h-screen justify-start items-center">
        <x-page-header 
            src="img/ProjectImg/carouselhouse.jpg"
            title="Casa da Mamé" fromPage="Projetos" toPage="Casa da mamé"
            ...
            <div class="grid grid-flow-row py-20 gap-6 lg:gap-20">
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <x-cards.outline 
                            title="Orfanato"
                            src="img/outline/house.jpg"
                            alt="Casa da Mamé"
                            abstract="Construímos um orfanato com capacidade para acolher 15 crianças de ambos os sexos."
                        />
                        <x-cards.outline 
                            title="Stock"
                            src="img/outline/stock.jpg"
                            alt="Stock de alimentos"
                            abstract="Fornecemos, regularmente, alimentos a Casa da Mamé: arroz, massa, azeite, óleo, 
                            papas lácteas, leite nido, ..."
                        />
                        <x-cards.outline 
                            title="Colaboradores"
                            src="img/outline/team.jpg"
                            alt="Colaboradores"
                            abstract="Empregamos e remuneramos 15 funcionários em Catió na Casa da Mamé, designadamente 
                            amas, ..."
                        />
                        <x-cards.outline 
                            title="Parque infantil"
                            src="img/outline/park.jpg"
                            alt="Parque de infantil"
                            abstract="Criamos um parque infantil, um espaço ao ar livre onde as nossas crianças pudessem brincar."
                        />
                        <x-cards.outline 
                            title="Sala de estudo"
                            src="img/outline/studyHall.jpg"
                            alt="Sala de estudo"
                            abstract="Temos uma sala de estudo onde as nossas crianças pudessem realizar as atividades lúdicas, 
                            pedagógicas..."
                        />
                    </div>
                </div>
                <div class="space-y-8">
                    <h3>Diário dos voluntários ou relatos de familiares</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <x-cards.witness 
                            name="Biamsum Siga"
                            role="Diretor"
