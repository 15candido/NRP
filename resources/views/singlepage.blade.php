            ...
            <div class="grid grid-flow-row py-20 gap-6 lg:gap-20">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="flex flex-col w-full h-auto gap-4">
                        <x-cards.info-default-card 
                            ...
                            description="A educação é um fator essencial para o desenvolvimento dos povos e a 
                    ...
                    <x-cards.imagecard 
                        src="img/projectImg/education.jpg"
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <x-cards.outline 
                            title="Angariação"
                            src="img/outline/container.jpg"
                            alt="Descarga do contentor"
                            abstract="Angariamos e distribuímos o conteúdo de 31 contentores de 76,4m3 de capacidade."
                        />
                        <x-cards.outline 
                            title="Salas de aula"
                            src="img/outline/classRoom.jpg"
                            alt="sala de aula"
                            abstract="Equipamos 210 salas de aula com quadros de giz, mesas, cadeiras, armários e portas."
                        />
                        <x-cards.outline 
                            title="Escolas"
                            src="img/outline/school.jpg"
                            alt="Escolas apoiadas"
                        ...
                        <x-cards.outline 
                            title="Bibliotecas"
                            src="img/outline/libary.jpg"
                            alt="Biblioteca infantil"
                            abstract="Criamos e montamos 5 bibliotecas com cerca de 10.000 livros, com o apoio da ONGD Portuguesa TABANCA."
                        />
                    </div>
                </div>
                <div class="space-y-4">
                    <h3>Relatos de satisfação</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                        <x-cards.witness 
                            name="Biamsum Siga"
                            role="Diretor"
