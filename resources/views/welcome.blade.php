            ...
            <div class="w-full">
                ...
                <div class="main-content-container">
                    ...
                    <x-cards.structureWithBg>
                        <x-cards.info-default-card title="Projetos em curso" description="Continuamos a trabalhar para fornecer material 
                        e mobiliários escolar às escolas de Catió, cuidado e alimentação às crianças da Casa da Mamé, apoio ao hospital 
                        Musna Sambú e cuidado às crianças com deficiência." />
                    ...
                    <x-cards.structureWhitOutBg>
                        <x-cards.info-default-card title="O que já alcançamos" description="Começou por ser “formação aos professores”, 
                    ...
                    <!-- How to help  -->
                    <x-cards.structureWithBg>
                        <x-cards.info-default-card title="Como ajudar?" description="Neste processo, de fazer o mundo num lugar melhor, 
                        todos contam. A iniciativa que tomar pode nos deixar mais perto do objetivo. Junte-se a nós, escolha como deseja 
                        contribuir na missão da “Na Rota dos Povos”." />
                    ...
                    <!-- Our partners -->
                    <x-cards.structureWhitOutBg>
                        <x-cards.info-default-card title="Parceiros" description="Não estamos sozinhos, nesta busca por um mundo melhor, 
