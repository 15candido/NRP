    ...
    <div class="flex flex-col min-h-screen justify-start items-center">
        ...
        <x-cards.structureWithBg>
            <div class="flex flex-col md:flex-row w-full h-full gap-6">
                <x-cards.infocard title="Missão" description="A nossa missão é apoiar o desenvolvimento dos países PALOP, fora dos grandes centros 
                        populacionais, em zonas carenciadas ao nível da educação, formação cultural, saúde, proteção 
                        infantil e do ambiente." />
                <x-cards.infocard title="Visão" description="Temos como objetivo apoiar e desenvolver ações para a defesa, elevação e manutenção 
                ...
                <x-cards.infocard title="valores" description="Temos presente que só a educação pode melhorar o desenvolvimento dos povos, daí o 
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 py-20 gap-6">
                ...
                <div class="flex flex-col w-full h-full gap-4">
                    <x-cards.info-default-card subtitle="Guiné-Bissau" abstract="Desde 2011 que focamos a nossa actividade na região mais carenciada da Guiné Bissau, a região de
                                ...
                                capital Bissau." description="A Guiné-Bissau é um pequeno país da África ocidental constituído por uma parte continental e 
                            ...
                            melhorias na educação e na saúde se podem revelar mais compensadoras." ratio="O rácio de alunos por sala de aula é de 101 alunos/sala." />
                </div>
            </div>
        </x-cards.structureWhitOutBg>
