    ...
    <div class="flex flex-col min-h-screen justify-start items-center">
            ...
            <div class="grid grid-flow-row">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div class="flex flex-col">
                        <x-cards.info-default-card title="Sobre nós" description="A Na Rota dos Povos é uma ONGD – Organização Não Governamental para o
        ...
        <x-cards.structureWithBg>
            <div class="flex flex-col md:flex-row w-full h-full gap-6">
                <x-cards.infocard title="Missão" description="A nossa missão é apoiar o desenvolvimento dos países PALOP, fora dos
                    grandes centros populacionais, em zonas carenciadas ao nível da educação, formação cultural, saúde, proteção 
                    infantil e do ambiente." />
                <x-cards.infocard title="Visão" description="Temos como objetivo apoiar e desenvolver ações para a defesa, elevação 
                    e manutenção da qualidade de vida do ser humano e do meio ambiente, através do desenvolvimento de atividades 
                    de caráter educativo, social, cultural, ambiental e desportivo." />
                <x-cards.infocard title="valores" description="Temos presente que só a educação pode melhorar o desenvolvimento dos 
                    povos, daí o nosso lema “A Educação é o Único Caminho”. " />
            </div>
        </x-cards.structureWithBg>
        <x-cards.structureWhitOutBg>
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    <x-cards.info-default-card subtitle="Guiné-Bissau" abstract="Desde 2011 que focamos a nossa actividade na região mais 
                        carenciada da Guiné Bissau, a região de Tombali, e temos a nossa sede da Delegação local na cidade de Catió, que dista 
                        cerca de 300 km da capital Bissau." description="A Guiné-Bissau é um pequeno país da África ocidental constituído por uma 
                        ...
                        educação e na saúde se podem revelar mais compensadoras." ratio="O rácio de alunos por sala de aula é de 101 alunos/sala." />
                </div>
            </div>
        </x-cards.structureWhitOutBg>
    </div>
