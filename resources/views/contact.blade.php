                ...
                <div class="flex flex-col space-y-6">
                    <div class="portugal-address flex flex-col pb-4 space-y-4">
                        ...
                        <div class="phone-number inline-flex space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" class="bi bi-phone-fill"
                                viewBox="0 0 16 16">
                ...
                <div class="relative z-10 bg-white rounded-xl shadow-lg p-4 hover:shadow-xl">
                    <form action="" class="flex flex-col space-y-4 h-full text-gray-600">
                        <div class="flex flex-col md:flex-row space-y-4 md:space-x-4 md:space-y-0 ">
                            <input 
                                type="text" placeholder="Nome" class="ring-1 ring-gray-50 w-full rounded-lg px-4 py-2
                                outline-none focus:ring-2 focus:ring-[#25caca] "
                            />
                            <input 
                                type="tel" placeholder="Telefone" class="ring-1 ring-gray-50 w-full rounded-lg px-4 
                                py-2 outline-none focus:ring-2 focus:ring-[#25caca] "
                            />
                        </div>
                        <div class="email">
                            <input 
                                type="email" placeholder="Email" class="ring-1 ring-gray-50 w-full rounded-lg px-4 
                                py-2 outline-none focus:ring-2 focus:ring-[#25caca]"
                            />
                        </div>
                        <div class="subject">
                            <input 
                                type="text" placeholder="Assunto" class="ring-1 ring-gray-50 w-full rounded-lg px-4 
                                py-2 outline-none focus:ring-2 focus:ring-[#25caca] "
                            />
                        </div>
                        <div class="message">
                            <textarea
                                name="" placeholder="Mensagem" rows="11" class="ring-1 ring-gray-50 w-full rounded-lg
