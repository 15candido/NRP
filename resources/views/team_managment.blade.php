<x-guestLayout>
    ...
    <div class="flex flex-col min-h-screen justify-center items-center">
        <x-page-header src="img/project/carouselManagment.jpg" title="Equipa de gestão" fromPage="Quem somos" toPage="Equipa de gestão" alt="Imagem da Na Rota dos Povos" /> <!--about us hero image -->
        <x-cards.structureWhitOutBg>
            <div class="flex flex-col py-20 gap-6">
                <div>
                    <x-cards.info-default-card title="Equipa de gestão" description="Lorem, ipsum dolor sit amet consectetur adipisicing elit. Dolore tempore nemo 
