<x-guestLayout>
    ...
    <div class="flex flex-col min-h-screen justify-center items-center">
        <x-page-header src="img/project/carouselSocial.jpg" title="Orgãos sociais" fromPage="quem somos" toPage="Orgãos sociais" alt="Imagem da Na Rota dos Povos" /> <!--about us hero image -->
