<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center p-4
    bg-gray-800 border border-transparent rounded-lg font-semibold text-xs text-white 
