...
<div x-data="{ open: false }">
    ...
    <div class="flex flex-wrap justify-end">
        ...
        <button  
            ...
            class="inline-block font-bold text-white bg-[#5ba057] hover:bg-[#4ca747] p-3 rounded-lg shadow-md">
            {{ __('Inscrever-me') }}
        <button > 
    </div>
                    ...
                    <section class="w-full  mx-auto space-y-4">
                        ...
                        <form wire:submit.prevent='register' class="space-y-4" id="RegisterForm">
                            ...
                            <div class="flex flex-col w-full space-y-2 ">
                                ...
                                cols="30" rows="7" placeholder="Qual é a sua motivação?">
                                </textarea>
                ...
                <x-slot name="footer">
                    ...
                    <div class="flex flex-col gap-4 justify-end">
                        ...
                        <div class="flex gap-2 justify-end">
                            ...
                            :disabled="$disabled" form="RegisterForm"  x-on:click=" open = false">
                                {{ __('Register') }}
