...
<div class="flex w-full h-auto justify-between px-6 py-4 shadow border">
    ...
    <div class="w-full gap-6 " :class="open ? 'flex' : 'hidden' ">
...
<ul class="flex flex-col ">
    <li class="px-6 py-3 border-b" id="Dashbaord">
        <a href="#"  class="inline-flex gap-6 text-sm text-gray-500 uppercase">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
            class="w-5 h-5">
    ...
    <li class="px-6 py-3 border-b" id="Project">
        <a href="#"  class="inline-flex gap-6 text-sm text-gray-500 uppercase">
    ...
    <li class="px-6 py-3 border-b" id="Campain">
        <a href="#"  class="inline-flex gap-6 text-sm text-gray-500 uppercase">
    ...
    <li class="px-6 py-3 border-b" id="HowToHelp">
        <a href="#" class="inline-flex gap-6 text-sm text-gray-500 uppercase" >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
    ...
    <li class="px-6 py-3 border-b" id="Contacts">
        <a href="#" class="inline-flex gap-6 text-sm text-gray-500 uppercase">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" 
            class="w-5 h-5">
