...
<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
    ...
    <div class="flex items-center justify-between p-5 border-b rounded-t">
        ...
        <button x-on:click="open = false"  type="button" class="text-gray-400 bg-transparent hover:bg-gray-100 hover:text-gray-900 
    ...
    <!-- Modal footer -->
    <div class="flex justify-end items-center p-6 gap-2 border-t border-gray-200 rounded-b">
        {{$footer}}
    </div>
</div>
