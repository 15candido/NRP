<div class="relative resize-w mt-10 p-2">
  <!-- Our causes -->
  <div class="grid grid-cols-1 md:grid-cols-8 p-2 gap-4">
    <!-- What are the problems/causes -->
    <div class="col-span-2 overflow-hidden">
      <div class="flex flex-wrap h-full items-center p-2">
    ...
    <div class="col-span-1 md:col-span-6 lg:shadow-lg 2xl:shadow-none bg-white/75">
      <div class="grid grid-cols-1 gap-4 md:flex md:flex-grow-1 md:basis-1/3">
        <x-cards.causes/>      
        <x-cards.causes/>
        <x-cards.causes/>
      </div>
...
<div class="grid grid-flow-row justify-items-center relative w-full resize-h overflow-hidden my-10 bg-gradient-to-r from-[#4ca747] via-[#019393] to-[#0082b3]">
  ...
  <div class="resize-w absolute h-full">
    <h1 class=" flex-1 text-white text-6xl font-bold">This is the Headline Text</h1>
    <h2 class=" flex-1 text-white text-3xl font-light mt-5">Some really stuff goes here.</h2>
  </div>
</div>
