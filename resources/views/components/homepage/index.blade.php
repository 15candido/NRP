  ...
  <div class="flex flex-row w-full max-w-7xl px-5 lg:px-10">
    ...
    <x-cards.structureWithBg>
      <x-cards.info-default-card 
        ...
        description="Continuamos a trabalhar para fornecer material e mobiliários escolar às escolas de Catió, 
        cuidado e alimentação às crianças da Casa da Mamé, apoio ao hospital Musna Sambú e cuidado às crianças 
        com deficiência."
      />
    ...
    <x-cards.structureWhitOutBg>
      <x-cards.info-default-card 
        ...
        description="Começou por ser “formação aos professores”, tornou-se numa missão de criar condições dignas de estudo 
        para cerca de 10.000 alunos, bolsas de estudo, casa de acolhimento para as crianças órfãs, bibliotecas e salas de 
        informática."
      />
    ...
    <x-cards.structureWithBg>
      <x-cards.info-default-card 
        title="Como ajudar?"
        description="Neste processo, de fazer o mundo num lugar melhor, todos contam. A iniciativa que tomar pode nos 
        deixar mais perto do objetivo. Junte-se a nós, escolha como deseja contribuir na missão da “Na Rota dos Povos”."
      />
    ...
    <x-cards.structureWhitOutBg>
      <x-cards.info-default-card 
        title="Parceiros"
        description="Não estamos sozinhos, nesta busca por um mundo melhor, mais justo e inclusivo, onde o ser humano e o 
        meio ambiente são centro das atenções. Temos vários parceiros que colaboram connosco, contribuindo de forma direta 
        e direta no desenvolvimento da na missão."
      />
